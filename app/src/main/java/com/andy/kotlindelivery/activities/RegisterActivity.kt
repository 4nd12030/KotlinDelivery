...
class RegisterActivity : AppCompatActivity() {
    ...
    private fun register(){
        ...
        if(isValidForm(nombre=nombre, apellido=apellido, emailRegistro=emailRegistro, telefono=telefono, contrasenaRegistro=contrasenaRegistro, contrasenaConfirma=contrasenaConfirmacion)){
